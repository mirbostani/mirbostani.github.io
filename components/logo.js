    ...
    <div className="flex flex-row">
      <LinkX href="/">
        <a className="flex flex-row items-center space-x-3">
          <div className="flex rounded-md overflow-hidden border border-gray-100 dark:border-gray-800">
            <ImageX
              src={member.thumb}
              alt={t("mirbostani_fullname")}
              width={54}
              height={54}
            />
          </div>
